...
public class ConductorProperties {
	...
	private static Map<Size, Double> TW;
	private static Map<Size, Double> RHW;
	private static Map<Size, Double> THW;
	private static Map<Size, Double> THWN;
	private static Map<Size, Double> ZW;
	private static Map<Size, Double> FEP;
	private static Map<Size, Double> FEPB;
	private static Map<Size, Double> RHH;
	private static Map<Size, Double> RHW2;
	private static Map<Size, Double> THHN;
	private static Map<Size, Double> THHW;
	private static Map<Size, Double> THW2;
	private static Map<Size, Double> THWN2;
	private static Map<Size, Double> XHH;
	private static Map<Size, Double> XHHW;
	private static Map<Size, Double> XHHW2;
	private static Map<Size, Double> EMPTY;
	private static Map<Insul, Map<Size, Double>> insulatedDimensions;//Table 5
	private static Map<Size, Double> compactRHH;
	private static Map<Size, Double> compactRHW;
	private static Map<Size, Double> compactUSE;
	private static Map<Size, Double> compactTHW;
	private static Map<Size, Double> compactTHHW;
	private static Map<Size, Double> compactTHHN;
	private static Map<Size, Double> compactXHHW;
	private static Map<Size, Double> compactBareDimensions;
	private static Map<Insul, Map<Size, Double>> compactDimensions;//Table 5A
	private static Map<TempRating, Insul[]> insulationTempMap;
	...
	private static class Properties{
		...
		public Properties(Size size, int cuAmp60, int cuAmp75, int cuAmp90, int alAmp60, int alAmp75, int alAmp90, double nonMagXL,
	...
	static {
		...
		table = new Properties[]{
				new Properties(Size.AWG_14,     15,  20,  25,  0,   0,   0,   0.058000, 0.073000, 3.100000, 3.100000, 3.100000, 4.130600, 4.130600, 4.130600, 4110,    3.070000, 3.190000, 5.060000),
				new Properties(Size.AWG_12,     20,  25,  30,  15,  20,  25,  0.054000, 0.068000, 2.000000, 2.000000, 2.000000, 3.200000, 3.200000, 3.200000, 6530,    1.930000, 2.010000, 3.180000),
				new Properties(Size.AWG_10,     30,  35,  40,  25,  30,  35,  0.054000, 0.068000, 1.200000, 1.200000, 1.200000, 2.000000, 2.000000, 2.000000, 10380,   1.210000, 1.260000, 2.000000),
				new Properties(Size.AWG_8,      40,  50,  55,  35,  40,  45,  0.050000, 0.063000, 0.780000, 0.780000, 0.780000, 1.300000, 1.300000, 1.300000, 16510,   0.764000, 0.786000, 1.260000),
				new Properties(Size.AWG_6,      55,  65,  75,  40,  50,  55,  0.051000, 0.064000, 0.490000, 0.490000, 0.490000, 0.810000, 0.810000, 0.810000, 26240,   0.491000, 0.510000, 0.808000),
				new Properties(Size.AWG_4,      70,  85,  95,  55,  65,  75,  0.048000, 0.060000, 0.310000, 0.310000, 0.310000, 0.510000, 0.510000, 0.510000, 41740,   0.308000, 0.321000, 0.508000),
				new Properties(Size.AWG_3,      85,  100, 115, 65,  75,  85,  0.047000, 0.059000, 0.250000, 0.250000, 0.250000, 0.400000, 0.410000, 0.400000, 52620,   0.245000, 0.254000, 0.403000),
				new Properties(Size.AWG_2,      95,  115, 130, 75,  90,  100, 0.045000, 0.057000, 0.190000, 0.200000, 0.200000, 0.320000, 0.320000, 0.320000, 66360,   0.194000, 0.201000, 0.319000),
				new Properties(Size.AWG_1,      110, 130, 145, 85,  100, 115, 0.046000, 0.057000, 0.150000, 0.160000, 0.160000, 0.250000, 0.260000, 0.250000, 83690,   0.154000, 0.160000, 0.253000),
				new Properties(Size.AWG_1$0,    125, 150, 170, 100, 120, 135, 0.044000, 0.055000, 0.120000, 0.130000, 0.120000, 0.200000, 0.210000, 0.200000, 105600,  0.122000, 0.127000, 0.201000),
				new Properties(Size.AWG_2$0,    145, 175, 195, 115, 135, 150, 0.043000, 0.054000, 0.100000, 0.100000, 0.100000, 0.160000, 0.160000, 0.160000, 133100,  0.096700, 0.101000, 0.159000),
				new Properties(Size.AWG_3$0,    165, 200, 225, 130, 155, 175, 0.042000, 0.052000, 0.077000, 0.082000, 0.079000, 0.130000, 0.130000, 0.130000, 167800,  0.076600, 0.079700, 0.126000),
				new Properties(Size.AWG_4$0,    195, 230, 260, 150, 180, 205, 0.041000, 0.051000, 0.062000, 0.067000, 0.063000, 0.100000, 0.110000, 0.100000, 211600,  0.060800, 0.062600, 0.100000),
				new Properties(Size.KCMIL_250,  215, 255, 290, 170, 205, 230, 0.041000, 0.052000, 0.052000, 0.057000, 0.054000, 0.085000, 0.090000, 0.086000, 250000,  0.051500, 0.053500, 0.084700),
				new Properties(Size.KCMIL_300,  240, 285, 320, 195, 230, 260, 0.041000, 0.051000, 0.044000, 0.049000, 0.045000, 0.071000, 0.076000, 0.072000, 300000,  0.042900, 0.044600, 0.070700),
				new Properties(Size.KCMIL_350,  260, 310, 350, 210, 250, 280, 0.040000, 0.050000, 0.038000, 0.043000, 0.039000, 0.061000, 0.066000, 0.063000, 350000,  0.036700, 0.038200, 0.060500),
				new Properties(Size.KCMIL_400,  280, 335, 380, 225, 270, 305, 0.040000, 0.049000, 0.033000, 0.038000, 0.035000, 0.054000, 0.059000, 0.055000, 400000,  0.032100, 0.033100, 0.052900),
				new Properties(Size.KCMIL_500,  320, 380, 430, 260, 310, 350, 0.039000, 0.048000, 0.027000, 0.032000, 0.029000, 0.043000, 0.048000, 0.045000, 500000,  0.025800, 0.026500, 0.042400),
				new Properties(Size.KCMIL_600,  350, 420, 475, 285, 340, 385, 0.039000, 0.048000, 0.023000, 0.028000, 0.025000, 0.036000, 0.041000, 0.038000, 600000,  0.021400, 0.022300, 0.035300),
				new Properties(Size.KCMIL_700,  385, 460, 520, 315, 375, 425, 0.038500, 0.048000, 0.021000, 0.026000, 0.021900, 0.032500, 0.038000, 0.033700, 700000,  0.018400, 0.018900, 0.030300),
				new Properties(Size.KCMIL_750,  400, 475, 535, 320, 385, 435, 0.038000, 0.048000, 0.019000, 0.024000, 0.021000, 0.029000, 0.034000, 0.031000, 750000,  0.017100, 0.017600, 0.028200),
				new Properties(Size.KCMIL_800,  410, 490, 555, 330, 395, 445, 0.037800, 0.047600, 0.018200, 0.023000, 0.020400, 0.027800, 0.032600, 0.029800, 800000,  0.016100, 0.016600, 0.026500),
				new Properties(Size.KCMIL_900,  435, 520, 585, 355, 425, 480, 0.037400, 0.046800, 0.016600, 0.021000, 0.019200, 0.025400, 0.029800, 0.027400, 900000,  0.014300, 0.014700, 0.023500),
				new Properties(Size.KCMIL_1000, 455, 545, 615, 375, 445, 500, 0.037000, 0.046000, 0.015000, 0.019000, 0.018000, 0.023000, 0.027000, 0.025000, 1000000, 0.012900, 0.013200, 0.021200),
				new Properties(Size.KCMIL_1250, 495, 590, 665, 405, 485, 545, 0.036000, 0.046000, 0.011351, 0.014523, 0.014523, 0.017700, 0.023436, 0.021600, 1250000, 0.010300, 0.010600, 0.016900),
				new Properties(Size.KCMIL_1500, 525, 625, 705, 435, 520, 585, 0.035000, 0.045000, 0.009798, 0.013127, 0.013127, 0.015000, 0.020941, 0.019300, 1500000, 0.008580, 0.008830, 0.014100),
				new Properties(Size.KCMIL_1750, 545, 650, 735, 455, 545, 615, 0.034000, 0.045000, 0.008710, 0.012275, 0.012275, 0.013100, 0.019205, 0.017700, 1750000, 0.007350, 0.007560, 0.012100),
				new Properties(Size.KCMIL_2000, 555, 665, 750, 470, 560, 630, 0.034000, 0.044000, 0.007928, 0.011703, 0.011703, 0.011700, 0.018011, 0.016600, 2000000, 0.006430, 0.006620, 0.010600),
		};
		//endregion
		...
		//However, I found in NEC table 310.104(A) that THHW is 75 when used in wet location, but 90 in dry locations.
		//XHHW is 90 for dry and damp but 75  for wet.
		//This information should be part of the enum and also the "application provisions" of the conductor as described in this table.
		insulationTempMap = new HashMap<>();
		insulationTempMap.put(TempRating.T60, new Insul[]{Insul.TW});
		insulationTempMap.put(TempRating.T75, new Insul[]{Insul.RHW, Insul.THW, Insul.THWN, Insul.USE, Insul.ZW});
		insulationTempMap.put(TempRating.T90, new Insul[]{Insul.TBS, Insul.SA, Insul.SIS, Insul.FEP, Insul.FEPB, Insul.MI, Insul.RHH, Insul.RHW2, Insul.THHN,
				Insul.THHW, Insul.THW2, Insul.THWN2, Insul.USE2, Insul.XHH, Insul.XHHW, Insul.XHHW2, Insul.ZW2});
		//endregion
