...
/**
 ...
 class.*/
public interface ROVoltDrop {
	/**
	 @return Returns the actual AC voltage drop for the calculated conductor
	 size, under the given conditions.
	 @see #getCalculatedSizeAC()
	 */
	double getActualVoltageDropPercentageAC();

	/**
	 Returns the actual DC voltage drop for the calculated conductor size,
     under
	...
	/**
	 Calculates and returns the AC voltage in volts at the load terminals under
	...
	/**
     ...
     resultMessage
	 field content must be checked to determine the reason.
	 */
	...
	/**
	 ...
	 the
	 given conditions) is less or equals to the given maximum voltage drop. If
	 the returned Size is null the user should check for errors in the
	 resultMessage field.
	...
	/**
	 ...
	 the
	 given conditions) is less or equals to the given maximum voltage drop. If
	 the returned value is null the user must check the resultMessage field
	 content.
	 @return The size of the conductor as defined in {@link Size}.
	 */
	...
	/**
	 Calculates and returns the DC voltage in volts at the load terminals under
	 the preset conditions.
	 @return The voltage at the load terminals in volts. If the result is zero,
	 the resultMessage field content must be checked to determine the reason.
	 */
	...
	/**
	 Returns the one way length of the circuit's calculated conductor size
     whose
	 AC voltage drop (under the given conditions) is less or equals to the
     given
	...
	/**
	 Returns the calculated one way length of the circuit's conductor size
     whose
	...
	/**
	 Returns the calculated one way length of the circuit's actual conductor
	 size
	 that would reach the given maximum voltage drop under actual conditions
	 . If
	 the returned value is zero, the user must check the resultMessage field
	 content.
	 @return The maximum conductor's length in feet.
	 */
	...
	/**
	 @return The maximum voltage drop in percentage, used to compute the the
	 size
	 and the maximum length of the circuit conductors that would have a voltage
