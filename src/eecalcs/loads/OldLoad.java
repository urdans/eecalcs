...
public abstract class OldLoad {
	...
	/**
	 ...
	 @see VoltageSystemAC
	 */
	public OldLoad(VoltageSystemAC voltageSystem, double nominalCurrent) {
	...
	/**
	 Constructs a OldLoad object with the following default values:
