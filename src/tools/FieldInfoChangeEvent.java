...
/**
 This class represents the information about changing in field values.
 It contains the name of the field that changed, its old and new values.
 */
public class FieldInfoChangeEvent {
     ...
     */
    public void addFieldChange(String fieldName, Object oldValue, Object newValue){
